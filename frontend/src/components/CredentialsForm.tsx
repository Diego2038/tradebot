...
//
// Styling note: the markup inside `credentials-metadata` is byte-identical in
// text content to the previous version (a property test counts substring
// occurrences over that region's textContent); only classes were added.
...
export function CredentialsForm(props: CredentialsFormProps): JSX.Element {
  ...
  return (
    <section aria-label="Credenciales de Alpaca" className="card">
      <div className="card__header">
        <h2 className="card__title">Credenciales de Alpaca</h2>
      ...
      <div className="card__body">
        ...
        {metadata.exists && (
          <div data-testid="credentials-metadata" className="meta-line">
        ...
        <form onSubmit={handleSubmit} className="grid grid--2col">
          <div className="field">
            <label className="field__label" htmlFor="credentials-api-key">
              API Key ID
            </label>
            <input
          ...
          <div className="field">
            <label className="field__label" htmlFor="credentials-secret">
              API Secret
            </label>
            <input
